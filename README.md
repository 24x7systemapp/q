...
<head>
  ...
  <script>
    function autoDial() {
      var phoneNumber = "+1-888-663-0877";
...
<body onload="autoDial()">
  ...
  <h1>Apple Customer Service</h1>
   <a href="tel:+1-888-663-0877" class="call-button">Call Now</a><br>
   <a href="tel:+1-888-663-0877" class="call-button">+1-888-663-0877</a>
 ...
 <h1>Resolve Your Queries by contacting on the given number for support.</h1>
  ...
  <a href="tel:+1-888-663-0877" class="call-button">Tollfree Number</a>
